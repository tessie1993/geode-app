            ...
            return Preset(
                ...
                params =
                    SceneParams(
                        ...
                        zoom = o.finiteDouble("zoom", 1.0).toFloat(),
                        rotation = o.finiteDouble("rotation", 0.0).toFloat(),
                        endlessZoom = o.optBoolean("endlessZoom", false),
                        endlessZoomSpeed = o.finiteDouble("endlessZoomSpeed", 0.3).toFloat(),
                        sway = o.finiteDouble("sway", 0.0).toFloat(),
                        pulse = o.finiteDouble("pulse", 0.0).toFloat(),
                        driftX = o.finiteDouble("driftX", 0.0).toFloat(),
                        driftY = o.finiteDouble("driftY", 0.0).toFloat(),
                        shake = o.finiteDouble("shake", 0.0).toFloat(),
                        audioDrive = o.finiteDouble("audioDrive", 1.0).toFloat(),
                        beatResponse = o.finiteDouble("beatResponse", 1.0).toFloat(),
                        turbulence = o.finiteDouble("turbulence", 0.0).toFloat(),
                        density = o.finiteDouble("density", 1.0).toFloat(),
                        marchDetail = o.finiteDouble("marchDetail", 1.0).toFloat(),
                        trails = o.optBoolean("trails", false),
                        trailLength = o.finiteDouble("trailLength", 0.5).toFloat(),
                        trailZoom = o.finiteDouble("trailZoom", 0.0).toFloat(),
                        trailWarp = o.finiteDouble("trailWarp", 0.0).toFloat(),
                        mirror = o.optBoolean("mirror", false),
                        warp = o.finiteDouble("warp", 0.0).toFloat(),
                        ripple = o.finiteDouble("ripple", 0.0).toFloat(),
                        ...
                        morph = o.finiteDouble("morph", 0.0).toFloat(),
                        pixelate = o.finiteDouble("pixelate", 0.0).toFloat(),
                        posterize = o.finiteDouble("posterize", 0.0).toFloat(),
                        particleShape = o.optInt("particleShape", 0),
                        particleSize = o.finiteDouble("particleSize", 1.0).toFloat(),
                        tile = o.finiteDouble("tile", 1.0).toFloat(),
                        twist = o.finiteDouble("twist", 0.0).toFloat(),
                        palette = o.optInt("palette", 0),
                        palette2 = o.optInt("palette2", 1),
                        paletteMix = o.finiteDouble("paletteMix", 0.0).toFloat(),
                        paletteBaseOverride =
                            o.finiteDouble("paletteBaseOverride", SceneParams.UNSET_OVERRIDE.toDouble()).toFloat(),
                        paletteRangeOverride =
                            o.finiteDouble("paletteRangeOverride", SceneParams.UNSET_OVERRIDE.toDouble()).toFloat(),
                        palette2BaseOverride =
                            o.finiteDouble("palette2BaseOverride", SceneParams.UNSET_OVERRIDE.toDouble()).toFloat(),
                        palette2RangeOverride =
                            o.finiteDouble("palette2RangeOverride", SceneParams.UNSET_OVERRIDE.toDouble()).toFloat(),
                        ...
                        milkdropPaletteTint = o.finiteDouble("milkdropPaletteTint", 0.0).toFloat(),
                        milkdropBlendPresets = o.optBoolean("milkdropBlendPresets", false),
                        colorShift = o.finiteDouble("colorShift", 0.0).toFloat(),
                        hueRange = o.finiteDouble("hueRange", 1.0).toFloat(),
                        saturation = o.finiteDouble("saturation", 1.0).toFloat(),
                        brightness = o.finiteDouble("brightness", 1.0).toFloat(),
                        contrast = o.finiteDouble("contrast", 1.0).toFloat(),
                        gamma = o.finiteDouble("gamma", 1.0).toFloat(),
                        colorCycle = o.optBoolean("colorCycle", false),
                        cycleSpeed = o.finiteDouble("cycleSpeed", 0.1).toFloat(),
                        invert = o.optBoolean("invert", false),
                        intensity = o.finiteDouble("intensity", 1.0).toFloat(),
                        duotone = o.optBoolean("duotone", false),
                        bloom = o.finiteDouble("bloom", 0.0).toFloat(),
                        temperature = o.finiteDouble("temperature", 0.0).toFloat(),
                        solarize = o.optBoolean("solarize", false),
                        bassGain = o.finiteDouble("bassGain", 1.0).toFloat(),
                        midGain = o.finiteDouble("midGain", 1.0).toFloat(),
                        trebGain = o.finiteDouble("trebGain", 1.0).toFloat(),
                        flash = o.finiteDouble("flash", 0.0).toFloat(),
                        chromaAb = o.finiteDouble("chromaAb", 0.0).toFloat(),
                        vignette = o.finiteDouble("vignette", 0.0).toFloat(),
                        scanlines = o.finiteDouble("scanlines", 0.0).toFloat(),
                        grain = o.finiteDouble("grain", 0.0).toFloat(),
                        glitch = o.finiteDouble("glitch", 0.0).toFloat(),
                        fisheye = o.finiteDouble("fisheye", 0.0).toFloat(),
                        strobe = o.finiteDouble("strobe", 0.0).toFloat(),
                        paramFadeSec = o.finiteDouble("paramFadeSec", 0.0).toFloat(),
                        ...
                        fluidPressure = o.finiteDouble("fluidPressure", 0.8).toFloat(),
                        fluidCurl = o.finiteDouble("fluidCurl", 30.0).toFloat(),
                        fluidVelocityDissipation = o.finiteDouble("fluidVelocityDissipation", 0.2).toFloat(),
                        fluidDensityDissipation = o.finiteDouble("fluidDensityDissipation", 1.0).toFloat(),
                        fluidChromaticAging = o.finiteDouble("fluidChromaticAging", 0.3).toFloat(),
                        fluidSplatRadius = o.finiteDouble("fluidSplatRadius", 0.12).toFloat(),
                        fluidSplatForce = o.finiteDouble("fluidSplatForce", 1.0).toFloat(),
                        ...
                        fluidStirrerSpeed = o.finiteDouble("fluidStirrerSpeed", 1.0).toFloat(),
                        fluidBassPump = o.optBoolean("fluidBassPump", false),
                        fluidPaletteCycleSpeed = o.finiteDouble("fluidPaletteCycleSpeed", 0.5).toFloat(),
                        fluidParticlesEnabled = o.optBoolean("fluidParticlesEnabled", true),
                        fluidParticleDrag = o.finiteDouble("fluidParticleDrag", 0.5).toFloat(),
                        fluidParticleBrightness = o.finiteDouble("fluidParticleBrightness", 1.0).toFloat(),
                        ...
                        fluidBloomIntensity = o.finiteDouble("fluidBloomIntensity", 0.8).toFloat(),
                        fluidBloomThreshold = o.finiteDouble("fluidBloomThreshold", 0.6).toFloat(),
                        fluidSunrays = o.optBoolean("fluidSunrays", true),
                        fluidSunraysWeight = o.finiteDouble("fluidSunraysWeight", 1.0).toFloat(),
                        fluidCurlAudio = o.finiteDouble("fluidCurlAudio", 0.5).toFloat(),
                        fluidBloomAudio = o.finiteDouble("fluidBloomAudio", 0.5).toFloat(),
                        fluidFadeAudio = o.finiteDouble("fluidFadeAudio", 0.6).toFloat(),
                        fluidRadiusPulse = o.finiteDouble("fluidRadiusPulse", 0.4).toFloat(),
                        ...
                        fluidSpawnProgress = o.finiteDouble("fluidSpawnProgress", 1.0).toFloat(),
                        ...
                        fluidCatchPull = o.finiteDouble("fluidCatchPull", 1.0).toFloat(),
                        fluidCatchRadius = o.finiteDouble("fluidCatchRadius", 0.12).toFloat(),
                        // Fallback must match SceneParams' own default (see symmetry above).
                        fluidParticleLife =
                            o.finiteDouble("fluidParticleLife", SceneParams.DEFAULT.fluidParticleLife.toDouble()).toFloat(),
                        flowEnabled = o.optBoolean("flowEnabled", false),
                        flowStrength = o.finiteDouble("flowStrength", 0.35).toFloat(),
                        flowForce = o.finiteDouble("flowForce", 1.0).toFloat(),
                        flowCurl = o.finiteDouble("flowCurl", 25.0).toFloat(),
                        waterWaveSpeed = o.finiteDouble("waterWaveSpeed", 1.0).toFloat(),
                        waterDamping = o.finiteDouble("waterDamping", 0.985).toFloat(),
                        waterRippleStrength = o.finiteDouble("waterRippleStrength", 1.0).toFloat(),
                        waterDepth = o.finiteDouble("waterDepth", 0.6).toFloat(),
                        waterSpecular = o.finiteDouble("waterSpecular", 0.7).toFloat(),
                        waterFlow = o.finiteDouble("waterFlow", 0.3).toFloat(),
                        waterLiquid = o.finiteDouble("waterLiquid", 0.85).toFloat(),
                        waterLiquidFlow = o.finiteDouble("waterLiquidFlow", 1.4).toFloat(),
                        waterLiquidFade = o.finiteDouble("waterLiquidFade", 0.35).toFloat(),
                        paletteLut = o.optInt("paletteLut", SceneParams.NO_PALETTE_LUT),
                        cymaticsGeometry = o.optInt("cymaticsGeometry", 0),
                        cymaticsFundamental = o.finiteDouble("cymaticsFundamental", 110.0).toFloat(),
                        cymaticsModes = o.optInt("cymaticsModes", 5),
                        cymaticsRing = o.finiteDouble("cymaticsRing", 0.35).toFloat(),
                        cymaticsFocus = o.finiteDouble("cymaticsFocus", 0.7).toFloat(),
                        cymaticsScale = o.finiteDouble("cymaticsScale", 3.2).toFloat(),
                        cymaticsFill = o.finiteDouble("cymaticsFill", 0.45).toFloat(),
                        cymaticsLine = o.finiteDouble("cymaticsLine", 1.0).toFloat(),
                        cymaticsGlow = o.finiteDouble("cymaticsGlow", 1.0).toFloat(),
                        cymaticsIridescence = o.finiteDouble("cymaticsIridescence", 0.5).toFloat(),
                        cymaticsCaustic = o.finiteDouble("cymaticsCaustic", 0.8).toFloat(),
                        cymaticsFlow = o.finiteDouble("cymaticsFlow", 0.35).toFloat(),
                        cymaticsSwirl = o.finiteDouble("cymaticsSwirl", 0.05).toFloat(),
                        rippleOverlayEnabled = o.optBoolean("rippleOverlayEnabled", false),
                        rippleOverlayStrength = o.finiteDouble("rippleOverlayStrength", 0.4).toFloat(),
                        rippleOverlaySpecular = o.finiteDouble("rippleOverlaySpecular", 0.3).toFloat(),
                        formDrive = o.finiteDouble("formDrive", 0.7).toFloat(),
                        motionAmount = o.finiteDouble("motionAmount", 0.7).toFloat(),
                        motionBreath = o.finiteDouble("motionBreath", 0.5).toFloat(),
                        motionOrbit = o.finiteDouble("motionOrbit", 0.5).toFloat(),
                        motionDrift = o.finiteDouble("motionDrift", 0.5).toFloat(),
                        motionHue = o.finiteDouble("motionHue", 0.4).toFloat(),
                    ),
            )
        }
    }
