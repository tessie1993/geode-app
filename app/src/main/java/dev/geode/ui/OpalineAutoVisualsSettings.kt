...
internal fun AutoVisualsGroup(viewModel: PlayerViewModel) {
    ...
    Column {
        Text(
            ...
            color = if (viz.randomEnabled) CreativeColors.mint else MaterialTheme.colorScheme.onSurfaceVariant,
        )
        Text(
    ...
    Column {
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            CreativeToggle(checked = viz.randomOnSection, onCheckedChange = viewModel::setRandomOnSection)
        }
        Text(
    ...
    Column {
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            CreativeToggle(checked = viz.randomIncludeStyles, onCheckedChange = viewModel::setRandomIncludeStyles)
        }
        Row(verticalAlignment = Alignment.CenterVertically) {
            Text(stringResource(R.string.autoviz_pick_presets), Modifier.weight(1f), style = MaterialTheme.typography.bodyMedium)
            CreativeToggle(checked = viz.randomIncludePresets, onCheckedChange = viewModel::setRandomIncludePresets)
        }
        if (MilkdropEngine.available) {
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                CreativeToggle(checked = viz.randomIncludeMilk, onCheckedChange = viewModel::setRandomIncludeMilk)
            }
        }
        Text(
            stringResource(
    ...
    Column {
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            CreativeToggle(checked = viz.randomizeColors, onCheckedChange = viewModel::setRandomizeColors)
        }
        Text(
    ...
    Column {
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            CreativeToggle(checked = viz.vizPlaylistEnabled, onCheckedChange = viewModel::setVizPlaylistEnabled)
        }
        Text(
            when {
    ...
    Column {
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            CreativeToggle(checked = viz.vizPlaylistIntelligent, onCheckedChange = viewModel::setVizPlaylistIntelligent)
        }
        Text(
