...
const std::array<const char*, 135>& SceneParams::fieldNames() {
    static const std::array<const char*, 135> kNames = {{
        ...
        "rippleOverlayEnabled", "rippleOverlayStrength", "rippleOverlaySpecular", "shapeMorph",
    }};
    return kNames;
}
